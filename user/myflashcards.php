...
<div class="container" style="margin-top: 100px;"> <!-- Dodany margines na górze -->
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <p class="card-text">Zobacz swoje fiszki z poziomu <?php echo $level_name; ?></p>
            <a href='allmyflashcards.php?level_id=<?php echo $level_id; ?>' class="btn btn-primary">Przejdź</a>
        </div>
    </div>
    <?php } ?>
</div>
